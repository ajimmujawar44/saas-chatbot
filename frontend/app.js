...
async function handleSendMessage() {
    ...
    //http://127.0.0.1:8000
    //https://2ndsaasbot-sooty.vercel.app/
    try {
        // Dynamic path configuration optimized for Vercel builds
        const response = await fetch('https://2ndsaasbot-sooty.vercel.app//api/chat', {
            method: 'POST',
            headers: { 
        ...
        botBubble.innerHTML = data.reply || "No reply field returned from server.";
    } catch (error) {
